    ...
    for idx, (images, labels, audio) in enumerate(train_loader):
        ...
        with torch.cuda.amp.autocast():
            if args.method == 'ce':
                ...
                #loss = criterion[0](output['ce_output'], labels)+criterion[1](output['only_mel'],output['combine'],labels)+ CB_loss(labels,output['ce_output'],[2250, 1051, 604, 308],4,"sigmoid", 0.9, 1.0)
